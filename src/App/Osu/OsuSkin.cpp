...
void OsuSkin::load()
{
	...
	checkLoadImage(&m_hitCircle4, "hitcircle4", "OSU_SKIN_HITCIRCLE4");
	...
	if (m_hitCircle4 != NULL && m_hitCircle4->getFilePath().find("@2x") != -1)
		m_bHitCircle4_2x = true;
