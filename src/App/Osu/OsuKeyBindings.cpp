...
ConVar OsuKeyBindings::K1("osu_key_1", (int)KEY_Z);
ConVar OsuKeyBindings::K2("osu_key_2", (int)KEY_X);
ConVar OsuKeyBindings::K3("osu_key_3", (int)KEY_C);
ConVar OsuKeyBindings::K4("osu_key_4", (int)KEY_V);
